...
description: Use this agent when working with database schemas, type definitions, validators, or data models in the ChittyOS ecosystem. Invoke for schema changes, type generation, breaking-change detection, fractal scope alignment, drift detection, and cross-service impact analysis.
model: opus
color: orange
canon_uri: chittycanon://core/services/chittyschema#agent-overlord
scope_uri: chittycanon://core/services/chittyschema
