...
import manifestSchema from '../../../identity/schemas/meta/manifest.schema.json';
// @ts-expect-error JSON imports
import tableOwnerSchema from '../../../identity/schemas/meta/table-owner.schema.json';
// @ts-expect-error JSON imports
import driftStateSchema from '../../../identity/schemas/meta/drift-state.schema.json';
// @ts-expect-error JSON imports
import serviceAnnouncementSchema from '../../../identity/schemas/meta/service-announcement.schema.json';
// @ts-expect-error JSON imports
import driftEventSchema from '../../../identity/schemas/meta/drift-event.schema.json';
// @ts-expect-error JSON imports
import ontologyResponseSchema from '../../../identity/schemas/meta/ontology-response.schema.json';
// @ts-expect-error JSON imports
import canonicalUriSchema from '../../../identity/schemas/meta/canonical-uri.schema.json';
// @ts-expect-error JSON imports
